...
GPh, glycogen phosphorylase (EC 2.4.1.1); Lac, lactate; LDH, lactate dehydrogenase (EC 1.1.1.27); PFK, phosphofructokinase (EC 2.7.1.11); GPI, glucose phosphate isomerase (EC 5.3.1.9.); Pyr, pyruvate. Subscripts: m, mitochondrial; c, cytosolic.</em></p>", revisions=""));
    ...
    <rdf:Description rdf:about=\"#\">
      ...
      centralMetabolism.extra_cellular.LACext_ LACext(c(
                                                      start = 0))
                                                                 "Lactate" annotation(Placement(transformation(origin={70.0,0.0}, extent={{-10.0,-10.0},{10.0,10.0}})));
...
", revisions=""),
    ...
    <rdf:Description rdf:about=\"#\">
      ...
      centralMetabolism.mitochondria.NADH_ NADHm(c(
                                                 start = 0))
                                                            "NADH" annotation(Placement(transformation(origin={-20.0,-10.0}, extent={{-10.0,-10.0},{10.0,10.0}})));
